...
<style>
    ...
    .side-menu__item.is-active .icon::after{
        --icon-ring: rgba(99,102,241,.12);
    }

    /* Color presets (bg/fg/ring) */
    .icon-1{ --icon-bg:#eef2ff; --icon-fg:#4338ca; --icon-ring: rgba(67,56,202,.12); }   /* Indigo */
    .icon-2{ --icon-bg:#fff7ed; --icon-fg:#c2410c; --icon-ring: rgba(194,65,12,.12); }   /* Orange */
    .icon-3{ --icon-bg:#ecfdf5; --icon-fg:#047857; --icon-ring: rgba(4,120,87,.12); }    /* Emerald */
    .icon-4{ --icon-bg:#e0f2fe; --icon-fg:#0369a1; --icon-ring: rgba(3,105,161,.12); }   /* Sky */
    .icon-5{ --icon-bg:#faf5ff; --icon-fg:#7e22ce; --icon-ring: rgba(126,34,206,.12); }  /* Violet */
    .icon-6{ --icon-bg:#fef2f2; --icon-fg:#b91c1c; --icon-ring: rgba(185,28,28,.12); }   /* Red */
    .icon-7{ --icon-bg:#ecfeff; --icon-fg:#0e7490; --icon-ring: rgba(14,116,144,.12); }  /* Cyan */
    .icon-8{ --icon-bg:#f0fdf4; --icon-fg:#16a34a; --icon-ring: rgba(22,163,74,.12); }   /* Green */
    .icon-9{ --icon-bg:#eff6ff; --icon-fg:#1d4ed8; --icon-ring: rgba(29,78,216,.12); }   /* Blue */
    .icon-10{ --icon-bg:#fdf4ff; --icon-fg:#a21caf; --icon-ring: rgba(162,28,175,.12); } /* Fuchsia */
