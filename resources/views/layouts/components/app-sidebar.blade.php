					...
					<aside class="app-sidebar">
						<div class="main-sidebar-header active">
							<a class="header-logo active" href="{{url('index')}}">
								<img src="{{asset('assets/img/brand/nijoga-logo.jpg')}}" class="" style="height: 70px;width: 150px;margin-left: 25px;margin-top: -15px;" alt="logo">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide">
									<a class="side-menu__item" href="{{url('admin/pratihari-profile')}}"><span class="side-menu__label"><img src="{{asset('assets/img/brand/monk.png')}}" style="height: 20px;width: 20px" alt="logo"><span class="side-menu__label" style="margin-left: 10px">Pratihari Profile</span></a>
								</li>
								...
								<li class="slide">
									<a class="side-menu__item" href="{{url('admin/pratihari-nijoga-seba')}}"><span class="side-menu__label"><img src="{{asset('assets/img/brand/pratihari.png')}}" style="height: 20px;width: 20px" alt="logo"><span class="side-menu__label" style="margin-left: 10px">Pratihari Nijoga Assign</span></a>
								</li>
								...
								<li class="slide">
									<a class="side-menu__item" href="{{route('superadmin.manageAdmin')}}">
										<span class="side-menu__label">
											<img src="{{asset('assets/img/brand/monk.png')}}" style="height: 20px;width: 20px" alt="logo">
