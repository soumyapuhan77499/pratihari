...
<div class="sticky">
    <aside class="app-sidebar">
        ...
        <div class="main-sidebar-header active">
            <a class="header-logo active d-flex align-items-center gap-2 text-decoration-none" href="{{ url('index') }}">
...
<style>
    ...
    .side-menu__item{
        ...
        color: var(--bs-body-color); position: relative; transition: transform .12s ease, background .2s ease, box-shadow .2s ease;
    }
    ...
    .gradient-1{ background: linear-gradient(135deg,#6366F1,#22D3EE); color:#fff; }
    .gradient-2{ background: linear-gradient(135deg,#F59E0B,#F97316); color:#fff; }
    .gradient-3{ background: linear-gradient(135deg,#22C55E,#10B981); color:#fff; }
    .gradient-4{ background: linear-gradient(135deg,#0EA5E9,#6366F1); color:#fff; }
    .gradient-5{ background: linear-gradient(135deg,#8B5CF6,#EC4899); color:#fff; }
    .gradient-6{ background: linear-gradient(135deg,#FB7185,#F43F5E); color:#fff; }
    .gradient-7{ background: linear-gradient(135deg,#06B6D4,#0EA5E9); color:#fff; }
    .gradient-8{ background: linear-gradient(135deg,#4ADE80,#22C55E); color:#fff; }
    .gradient-9{ background: linear-gradient(135deg,#60A5FA,#34D399); color:#fff; }
    .gradient-10{ background: linear-gradient(135deg,#F472B6,#F59E0B); color:#fff; }
