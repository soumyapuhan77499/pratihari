                ...
                <div class="card-header bg-primary text-white">
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        <div class="ms-auto d-flex flex-wrap gap-2">
                            <span class="badge text-bg-success"><i class="fa-solid fa-check-circle me-1"></i>Approved</span>
                            <span class="badge text-bg-warning text-dark"><i class="fa-solid fa-pen-to-square me-1"></i>Updated</span>
                            <span class="badge text-bg-secondary"><i class="fa-regular fa-hourglass-half me-1"></i>Pending</span>
                            <span class="badge text-bg-danger"><i class="fa-solid fa-xmark-circle me-1"></i>Rejected</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-2 align-items-center">
                        <div class="col-12 col-md-7">
                            <div class="input-group">
                                ...
                                <input id="searchBox" type="search" class="form-control" placeholder="Search name or phone…" aria-label="Search">
                            </div>
                        </div>
                            ...
                            <table id="profiles-table" class="table table-striped table-hover align-middle">
                                ...
                                @foreach ($profiles as $index => $profile)
                                    ...
                                    <tr data-status="{{ $status }}">
                                        ...
                                        <td>
                                            <a href="{{ route('admin.viewProfile', $profile->pratihari_id) }}" data-bs-toggle="tooltip" title="Open full profile">
                                        ...
                                        <td>
                                            <a href="{{ route('admin.viewProfile', $profile->pratihari_id) }}" class="btn btn-sm btn-dark">
                                        ...
                                        <td class="text-nowrap">
                                            @if ($status === 'updated')
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <button class="btn btn-success btn-sm approve-btn" data-id="{{ $profile->id }}">
                                                        <i class="fa-solid fa-thumbs-up me-1"></i>Approve
                                                    </button>
                                                    <button class="btn btn-danger btn-sm reject-btn" data-id="{{ $profile->id }}">
                                                        <i class="fa-solid fa-thumbs-down me-1"></i>Reject
                                                    </button>
                                                </div>
                                            @else
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <a class="btn btn-outline-primary" href="{{ route('admin.viewProfile', $profile->pratihari_id) }}">
                                                        <i class="fa-regular fa-id-card me-1"></i>Details
                                                    </a>

                                                    @if ($status === 'rejected' && !empty($profile->reject_reason))
                                                        <button type="button" class="btn btn-outline-danger show-reject-reason"
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            <tbody>
                                <tr><th class="w-25"><i class="fas fa-map-marker-alt me-1"></i> Address</th><td id="modal-address">N/A</td></tr>
        ...
        $(function () {
            ...
            $('.approve-btn').on('click', function () {
                ...
                Swal.fire({
                    ...
                    if (r.isConfirmed) {
                        Swal.showLoading();
                        $.post('/admin/pratihari/approve/' + id, { _token: csrf })
            ...
            $('.reject-btn').on('click', function () {
                ...
                Swal.fire({
                    ...
                    if (r.isConfirmed) {
                        Swal.showLoading();
                        $.post('/admin/pratihari/reject/' + id, { _token: csrf, reason: r.value })
