        ...
        <div class="col-12 mt-2">
            <div class="card shadow-lg">
                ...
                <ul class="nav nav-tabs flex-column flex-sm-row mt-2" role="tablist">
                    ...
                    <li class="nav-item col-12 col-sm-auto">
                        <a class="nav-link" id="family-tab" style="background-color: rgb(49, 49, 181);color: white"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if (isset($family) && $family->father_photo)
                                        <img src="{{ asset($family->father_photo) }}" alt="Father Photo" width="100">
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if (isset($family) && $family->mother_photo)
                                        <img src="{{ asset($family->mother_photo) }}" alt="Mother Photo" width="100">
                                    @endif
                                </div>

                                <!-- Marital Status -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label"><i class="fa fa-heart" style="color: blue"></i> Marital
                                        Status</label>
                                ...
                                <div class="row" id="spouseDetails" style="display: none;">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @if (isset($family) && $family->spouse_photo)
                                            <img src="{{ asset($family->spouse_photo) }}" alt="Spouse Photo"
                                                width="100">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-12" id="childrenSection">
                                    ...
                                    <h5 class="mt-3"><i class="fas fa-child" style="color: blue"></i> Children Details
                                    </h5>
                                    <button type="button" class="btn btn-sm btn-success" id="addChild">
                                        <i class="fa fa-plus-circle"></i> Add Child
                                    </button>
                                    <div id="childrenContainer">
                                        @if ($family && $family->children->isNotEmpty())
                                                ...
                                                <div class="row child-row mt-3 border p-3 rounded bg-light">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            ...
                                                            value="{{ old('children.' . $index . '.dob', $child->dob) }}">
                                                    </div>
                                                    <div class="col-md-2">
