...
@section('styles')
    ...
    <style>
        ...
        /* Tabs */
        .nav-tabs{ border:0; background:#fff; border-radius:12px; padding:.4rem; box-shadow:0 6px 18px rgba(2,6,23,.06); }
        .nav-tabs .nav-link{
        ...
        .nav-tabs .nav-link:hover{ background:#eef2ff; color:var(--ink); transform:translateY(-1px); border-color:rgba(124,58,237,.25); }
    ...
    <div class="col-12 mt-3">
        <div class="card shadow-lg">
          <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.viewProfile', ['pratihari_id' => $family->pratihari_id]) }}"
            ...
            <div class="card-body pt-2">
                <form
                    ...
                    @csrf
                    @if (isset($family)) @method('PUT') @endif

                    <div class="row section-gap">
                        <input type="hidden" name="pratihari_id" value="{{ old('pratihari_id', $family->pratihari_id ?? '') }}">
                        ...
                        <!-- Father Photo Modal -->
                        <div class="modal fade" id="fatherPhotoModal" tabindex="-1" aria-labelledby="fatherPhotoModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        @if (!empty($family) && !empty($family->father_photo))
                                            <img src="{{ asset($family->father_photo) }}" class="img-fluid rounded" alt="Father Photo">
                                        @else
                        ...
                        <!-- Mother Photo Modal -->
                        <div class="modal fade" id="motherPhotoModal" tabindex="-1" aria-labelledby="motherPhotoModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body text-center">
                                        @if (!empty($family) && !empty($family->mother_photo))
                                            <img src="{{ asset($family->mother_photo) }}" class="img-fluid rounded" alt="Mother Photo">
                                        @else
                        ...
                        <!-- Marital Status -->
                        <div class="col-md-6">
                            <label class="form-label d-block"><i class="fa fa-heart me-1" style="color:var(--accent)"></i> Marital Status</label>
                        ...
                        <div class="row mt-2" id="spouseDetails" style="display:none;">
                            ...
                            <!-- Spouse Photo Modal -->
                            <div class="modal fade" id="spousePhotoModal" tabindex="-1" aria-labelledby="spousePhotoModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body text-center">
                                            @if (!empty($family) && !empty($family->spouse_photo))
                                                <img src="{{ asset($family->spouse_photo) }}" class="img-fluid rounded" alt="Spouse Photo">
                                            @else
                        ...
                        <div class="col-12 mt-3">
                            <div class="d-flex align-items-center justify-content-between">
                                <h5 class="mb-0"><i class="fas fa-child me-2" style="color:var(--accent)"></i>Children Details</h5>
                            ...
                            <div id="childrenContainer" class="mt-2">
                                @php
                                    $childrenList = (isset($family) && isset($family->children)) ? $family->children : collect();
                                @endphp
                                    ...
                                    @foreach ($childrenList as $index => $child)
                                        <div class="row child-row mt-3 border p-3 rounded bg-light-subtle">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="children[{{ $index }}][name]"
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="file" class="form-control" name="children[{{ $index }}][photo]">
                                                @if ($child->photo)
                                                    <button type="button" class="btn btn-outline-secondary btn-sm mt-2"
                                                            data-bs-toggle="modal" data-bs-target="#childPhotoModal{{ $index }}">
                                                        View Full Image
                                                    </button>
                                                @endif
                                            </div>
                                            ...
                                            @if ($child->photo)
                                                <div class="modal fade" id="childPhotoModal{{ $index }}" tabindex="-1"
                                                     aria-labelledby="childPhotoModalLabel{{ $index }}" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="childPhotoModalLabel{{ $index }}">Child Photo</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <img src="{{ asset($child->photo) }}" class="img-fluid rounded" alt="Child Photo">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
