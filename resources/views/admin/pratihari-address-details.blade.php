    ...
    <div class="container-fluid my-3">
        ...
        <div class="tabbar mb-3">
            <ul class="nav" id="profileTabs" role="tablist">
                ...
                <li class="nav-item">
                    <button class="nav-link active" id="tab-address" data-bs-toggle="tab" data-bs-target="#pane-address"
                        type="button" role="tab" aria-controls="pane-address" aria-selected="true">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.pratihari-address.store') }}" method="POST" enctype="multipart/form-data"
                    novalidate>
                    @csrf
                    ...
                    <div class="tab-content" id="tabsContent">
                        ...
                        <!-- ADDRESS (active) -->
                        <div class="tab-pane fade show active" id="pane-address" role="tabpanel"
                            ...
                            <div class="row g-3">
                                <!-- Sahi -->
                                <label class="form-label" for="sahi">Sahi <span class="text-danger">*</span></label>
                                <div class="underline-group">
                                    <span class="chip" aria-hidden="true"><i
                                            class="fa-solid fa-location-crosshairs"></i></span>
                                    <select class="form-select" id="sahi" name="sahi" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="underline-group">
                                        ...
                                        <input type="text" class="form-control" id="landmark" name="landmark"
                                            placeholder="Nearby landmark" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="underline-group">
                                        ...
                                        <input type="text" class="form-control" id="police_station"
                                            name="police_station" placeholder="Police station" autocomplete="off">
                                    </div>
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="same_as_permanent_address"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="underline-group">
                                                ...
                                                <input type="text" class="form-control" id="per_landmark"
                                                    name="per_landmark" placeholder="Nearby landmark" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="underline-group">
                                                <span class="chip" aria-hidden="true"><i
                                                        class="fa-regular fa-envelope"></i></span>
                                                <input type="text" class="form-control" id="per_post"
                                                    name="per_post" placeholder="Post office" autocomplete="off">
                                            </div>
                                        </div>

                                        <!-- Permanent Police Station -->
                                        <div class="col-md-3">
                                            <label class="form-label" for="per_police_station">Permanent Police
                                                Station</label>
                                            <div class="underline-group">
                                                <span class="chip" aria-hidden="true"><i
                                                        class="fa-solid fa-shield-halved"></i></span>
                                                <input type="text" class="form-control" id="per_police_station"
                                                    name="per_police_station" placeholder="Police station"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="underline-group">
                                                ...
                                                <input type="text" class="form-control" id="per_pincode"
                                                    name="per_pincode" inputmode="numeric" maxlength="6"
                                                    pattern="\d{6}" placeholder="6-digit pincode">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="underline-group">
                                                ...
                                                <input type="text" class="form-control" id="per_district"
                                                    name="per_district" placeholder="District" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="underline-group">
                                                <span class="chip" aria-hidden="true"><i
                                                        class="fa-regular fa-map"></i></span>
                                                <input type="text" class="form-control" id="per_state"
                                                    name="per_state" placeholder="State" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="underline-group">
                                                ...
                                                <input type="text" class="form-control" id="per_country"
                                                    name="per_country" placeholder="Country" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="underline-group">
                                                <span class="chip" aria-hidden="true"><i
                                                        class="fa-regular fa-address-card"></i></span>
                                                <textarea class="form-control" id="per_address" name="per_address" rows="2"
                                                    placeholder="Street, area, house no."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
        (function() {
            ...
            function setPermanentRequired(isRequired) {
                // Fields marked with data-permanent="1"
                const permFields = section.querySelectorAll('[data-permanent="1"]');
                permFields.forEach(el => {
                    el.required = isRequired;
                });
            }

            function updatePermanentVisibility() {
                const isDifferent = !!toggle?.checked; // checked => NOT same => show permanent section
                section.style.display = isDifferent ? 'block' : 'none';

                // only require permanent when section is visible (different)
                setPermanentRequired(isDifferent);
            }

            if (toggle) {
                toggle.addEventListener('change', updatePermanentVisibility);
            }
            updatePermanentVisibility();

            if (form) {
                form.addEventListener('submit', function(e) {
                    // Current sahi required always
                    if (!sahi || !sahi.value) {
                        e.preventDefault();
                        Swal.fire({
                            icon: 'error',
                            title: 'Required Field Missing',
                            text: 'Please select Current Address Sahi.',
                            confirmButtonColor: '#ef4444'
                        });
                        return;
                    }

                    // If permanent is different, validate permanent required fields
                    const isDifferent = !!toggle?.checked;
                    if (isDifferent) {
                        const permRequired = section.querySelectorAll('[data-permanent="1"]');
                        let missing = false;

                        permRequired.forEach(el => {
                        ...
                        if (missing) {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Required Permanent Address Fields Missing',
                                text: 'Permanent Sahi, Pincode, Address and other required fields must be filled when permanent address is different.',
                                confirmButtonColor: '#ef4444'
                            });
                        }
                    }
