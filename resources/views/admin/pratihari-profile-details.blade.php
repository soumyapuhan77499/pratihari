...
@section('styles')
    ...
    <style>
        ...
        /* ===== New: switch tiles (Bhagari / Baristha) ===== */
        .switch-tile {
            display: flex;
            align-items: center;
            gap: .85rem;
    ...
    <div class="container-fluid my-3">
        ...
        <div class="tabbar mb-3">
            <ul class="nav" id="profileTabs" role="tablist">
                <li class="nav-item"><button class="nav-link active" id="tab-profile" data-bs-toggle="tab"
                        data-bs-target="#pane-profile" type="button" role="tab" aria-controls="pane-profile"
                        aria-selected="true"><i class="fa-solid fa-user"></i> Profile</button></li>
                <li class="nav-item"><button class="nav-link" id="tab-family" data-bs-toggle="tab"
                        data-bs-target="#pane-family" type="button" role="tab" aria-controls="pane-family"
                        aria-selected="false"><i class="fa-solid fa-users"></i> Family</button></li>
                <li class="nav-item"><button class="nav-link" id="tab-id" data-bs-toggle="tab" data-bs-target="#pane-id"
                        type="button" role="tab" aria-controls="pane-id" aria-selected="false"><i
                            class="fa-solid fa-id-card"></i> ID Card</button></li>
                <li class="nav-item"><button class="nav-link" id="tab-address" data-bs-toggle="tab"
                        data-bs-target="#pane-address" type="button" role="tab" aria-controls="pane-address"
                        aria-selected="false"><i class="fa-solid fa-location-dot"></i> Address</button></li>
                <li class="nav-item"><button class="nav-link" id="tab-occupation" data-bs-toggle="tab"
                        data-bs-target="#pane-occupation" type="button" role="tab" aria-controls="pane-occupation"
                        aria-selected="false"><i class="fa-solid fa-briefcase"></i> Occupation</button></li>
                <li class="nav-item"><button class="nav-link" id="tab-seba" data-bs-toggle="tab"
                        data-bs-target="#pane-seba" type="button" role="tab" aria-controls="pane-seba"
                        aria-selected="false"><i class="fa-solid fa-gears"></i> Seba</button></li>
                <li class="nav-item"><button class="nav-link" id="tab-social" data-bs-toggle="tab"
                        data-bs-target="#pane-social" type="button" role="tab" aria-controls="pane-social"
                        aria-selected="false"><i class="fa-solid fa-share-nodes"></i> Social Media</button></li>
            </ul>
        </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="middle_name" name="middle_name"
                                            autocomplete="off" value="{{ old('middle_name') }}" placeholder="(Optional)">
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="alias_name" name="alias_name"
                                            autocomplete="off" value="{{ old('alias_name') }}"
                                            placeholder="Also known as">
                                    </div>
                                </div>
                            </div>

                            {{-- ✅ NEW: Bhagari + Baristha Bhai Pua (aligned tiles) --}}
                                    ...
                                    <div class="switch-tile">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="baristha_bhai_pua"
                                                ...
                                                {{ old('baristha_bhai_pua', 0) ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" class="form-control" id="whatsapp_no" name="whatsapp_no"
                                            ...
                                            value="{{ old('whatsapp_no') }}" placeholder="10-digit number">
                                    </div>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" class="form-control" id="phone_no" name="phone_no"
                                            pattern="\d{10}" maxlength="10" autocomplete="off"
                                            value="{{ old('phone_no') }}" placeholder="10-digit number">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="healthcard_no"
                                            name="healthcard_no" autocomplete="off" value="{{ old('healthcard_no') }}"
    ...
    <script>
        function toggleDateField() {
            ...
            if (checked) {
                ...
                // restore old selection (best-effort)
                const oldYear = @json(old('joining_year'));
                if (oldYear) {
                    const sel = document.getElementById('joining_year');
                    if (sel) sel.value = oldYear;
                }
            }
        }
