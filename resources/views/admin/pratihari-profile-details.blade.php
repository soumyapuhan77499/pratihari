...
@section('styles')
    ...
    <style>
        :root{
            --sp-ink: #1e1b4b;        /* Deep Indigo */
            --sp-saffron: #f59e0b;    /* Saffron/Amber */
            --sp-rose: #e11d48;       /* Rose */
            --sp-teal: #0ea5a4;       /* Teal */
            --sp-cream: #fef9e8;      /* Soft cream bg accents */
            --sp-light: #fdfcf7;
            --sp-muted: #6b7280;
        }
        ...
        .nav-pills.sp-tabs .nav-link i{ color: var(--sp-ink); }
        ...
        .nav-pills.sp-tabs .nav-link.active i{ color: #fff; }

        /* Inputs */
        .form-label{ font-weight: 700; color: var(--sp-ink); }
        .input-group-text{
            background: linear-gradient(135deg, #f59e0b, #e11d48);
            color: #fff;
            border: none;
        ...
        /* Helpers */
        .muted{ color: var(--sp-muted); font-size: .92rem; }
    </style>
@endsection
    ...
    <div class="col-12 mt-4">
        <div class="card sp-card shadow-lg">
            ...
            <div class="px-3 px-sm-4 pt-3 pt-sm-4">
                <!-- Tabs -->
                <ul class="nav nav-pills sp-tabs flex-column flex-sm-row gap-2 gap-sm-3 mb-3 mb-sm-4" id="spTab" role="tablist">
                    ...
                    <div class="tab-content" id="spTabContent">
                                    ...
                                    <div class="row g-3 align-items-end">
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="remember_date" onchange="toggleDateField()">
                        ...
                        <div class="tab-pane fade" id="family-pane" role="tabpanel" aria-labelledby="family-tab">
                            <div class="alert alert-info mb-0">
                                This section can hold family details in the next iteration. Current form fields are under <strong>Profile</strong>.
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="occupation-pane" role="tabpanel" aria-labelledby="occupation-tab">
                            <div class="alert alert-info mb-0">
                        ...
                        <!-- SEBA (placeholder) -->
                        <div class="tab-pane fade" id="seba-pane" role="tabpanel" aria-labelledby="seba-details-tab">
                            <div class="alert alert-info mb-0">
                        ...
                        <!-- SOCIAL (placeholder) -->
                        <div class="tab-pane fade" id="social-pane" role="tabpanel" aria-labelledby="social-media-tab">
                            <div class="alert alert-info mb-0">
