...
@section('styles')
    ...
    <style>
        ...
        .donut {
            flex: 0 0 132px;
            /* fixed width to keep a clean row */
            display: flex;
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <div class="donut-card p-2 p-sm-3">
                    <div class="donut-rail">
                        ...
                        <a class="donut text-decoration-none"
                            href="{{ route('seba.update', ['pratihari_id' => $profile->pratihari_id]) }}" title="Edit Seba">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="personal" role="tabpanel">
                <div class="section-card p-3 p-md-4">
                    <div class="section-head">
                        <h6 class="section-title"><i class="fa-solid fa-user-circle me-2"
                                style="color:var(--amber)"></i>Personal Details</h6>
                    ...
                    <div class="row">
                        <div class="col-lg-6 profile-section">
                            <div class="profile-item"><i class="fa-solid fa-user-tag"></i>
                                <div><span class="key">Alias Name</span><span
                                        class="val">{{ $profile->alias_name ?? 'Not Available' }}</span></div>
                            </div>
                            <div class="profile-item"><i class="fa-solid fa-id-card-clip"></i>
                                <div><span class="key">Health Card No</span><span
                                        class="val">{{ $profile->healthcard_no ?? 'Not Available' }}</span></div>
                            </div>
                            <div class="profile-item"><i class="fa-solid fa-cake-candles"></i>
                                <div><span class="key">Date of Birth</span><span
                                        class="val">{{ $profile->date_of_birth ?? 'Not Available' }}</span></div>
                            </div>
                        </div>
                        <div class="col-lg-6 profile-section">
                            <div class="profile-item"><i class="fa-solid fa-droplet"></i>
                                <div><span class="key">Blood Group</span><span
                                        class="val">{{ $profile->blood_group ?? 'Not Available' }}</span></div>
                            </div>
                            <div class="profile-item"><i class="fa-solid fa-calendar-check"></i>
                                <div><span class="key">Joining Date</span><span
                                        class="val">{{ $profile->joining_date ?? 'Not Available' }}</span></div>
                            </div>
            ...
            <div class="tab-pane fade" id="address" role="tabpanel">
                <div class="section-card p-3 p-md-4">
                    ...
                    <h6 class="fw-bold mt-1 mb-2"><i class="fa-solid fa-map-pin me-2 text-success"></i>Current Address
                    </h6>
