...
@section('styles')
    ...
    <style>
        ...
        .form-check .form-check-input{
            ...
            border:2px solid #3248c7; border-radius:6px; transition:.2s;
            margin-right:.45rem;
        }
        .form-check .form-check-input:checked{ background:#0d0d0c;border-color:#2d11e9; }
        .form-check .form-check-input:hover{ box-shadow:0 0 8px rgba(53,104,246,.35); }
        .form-check-label{cursor:pointer;font-weight:600;color:var(--ink);}
        ...
        .beddha-group .title{
            font-weight:800;color:var(--ink); display:flex; align-items:center; gap:.5rem;
        }
        ...
        /* === STRICT 10 PER ROW for Bheddha === */
        .beddha-pills{
            display:grid;
            grid-template-columns:repeat(10, minmax(0, 1fr)); /* 10 columns always */
            gap:.5rem;
            margin-top:.6rem;
        }
        /* Each grid cell filled by the pill */
        .beddha-pill{
            width:100%;
            min-height:38px;
        ...
        .beddha-pill:hover{ transform: translateY(-1px); box-shadow:0 6px 14px rgba(2,6,23,.06); }
        .beddha-pill .form-check-input{
            width:20px;height:20px;border:2px solid #3248c7;border-radius:6px;margin:0;flex:0 0 auto;
        }
        .beddha-pill .form-check-input:checked{ background:#0d0d0c;border-color:#2d11e9; }
        .beddha-pill .form-check-input:hover{ box-shadow:0 0 8px rgba(53,104,246,.35); }
        .pill-icon{
            width:18px; display:inline-flex; align-items:center; justify-content:center;
            color:var(--brand-a); flex:0 0 auto; font-size:.9rem;
        }
        .pill-text{
            display:block; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;
            flex:1 1 auto; font-weight:600; color:var(--ink); font-size:.9rem;
        }
                ...
                <div class="tab-content" id="tabsContent">
                    ...
                    <div class="tab-pane fade show active" id="pane-seba" role="tabpanel" aria-labelledby="tab-seba">
                        ...
                        <div class="mt-4" id="beddha_section" style="display:none;">
                            ...
                            <div id="beddha_list" class="d-flex flex-column gap-2" aria-live="polite"></div>
                        </div>
...
@section('scripts')
    ...
    (function(){
        ...
        // Render a single Bheddha group (10-per-row)
        function renderBeddhaGroup(sebaId, sebaName, items){
            ...
            header.innerHTML = `<span class="title-chip"><i class="fa-solid fa-hands-praying"></i> ${sebaName}</span>`;
