...
<div class="container-fluid my-3">
    ...
    <div class="page-header mb-3">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div>
                ...
                <div class="small opacity-75">Add your public profile links with the same look & feel as other pages.</div>
            </div>
        </div>
    </div>
    ...
    <div class="tabbar mb-3">
        <ul class="nav" id="profileTabs" role="tablist">
            ...
            <li class="nav-item">
                <button class="nav-link active" id="tab-social" data-bs-toggle="tab" data-bs-target="#pane-social" type="button" role="tab" aria-controls="pane-social" aria-selected="true">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.social-media.store') }}" method="POST" onsubmit="return validateForm()" novalidate>
                @csrf
                ...
                <div class="tab-content" id="tabsContent">
                    ...
                    <!-- SOCIAL (active) -->
                    <div class="tab-pane fade show active" id="pane-social" role="tabpanel" aria-labelledby="tab-social">
                        <div class="mb-2">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="underline-group">
                                    <span class="chip"><i class="fab fa-facebook-f"></i></span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="underline-group">
                                    <span class="chip"><i class="fab fa-x-twitter"></i></span>
                                    <input type="text" name="twitter" id="twitter" class="form-control"
                                           placeholder="https://x.com/... or https://twitter.com/..." value="{{ old('twitter') }}">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="underline-group">
                                    <span class="chip"><i class="fab fa-instagram"></i></span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="underline-group">
                                    <span class="chip"><i class="fab fa-linkedin-in"></i></span>
                                    <input type="text" name="linkedin" id="linkedin" class="form-control"
                                           placeholder="https://linkedin.com/in/... or /company/..." value="{{ old('linkedin') }}">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="underline-group">
                                    <span class="chip"><i class="fab fa-youtube"></i></span>
                                    <input type="text" name="youtube" id="youtube" class="form-control"
                                           placeholder="https://youtube.com/@handle or /channel/..." value="{{ old('youtube') }}">
                                </div>
