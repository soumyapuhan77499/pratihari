        ...
        <div class="col-12 mt-3">
            <div class="card shadow-lg">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.viewProfile', ['pratihari_id' => $pratihariAddress->pratihari_id]) }}"
                ...
                <div class="card-body">
                    <form action="{{ route('admin.pratihari-address.update', $pratihariAddress->pratihari_id) }}"
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="sahi" name="sahi">
                                        ...
                                        @foreach ($sahiList as $sahi)
                                            <option value="{{ $sahi->id }}"
                                                {{ old('sahi', $pratihariAddress->sahi) == $sahi->id ? 'selected' : '' }}>
                                                {{ $sahi->sahi_name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="post" name="post"
                                        value="{{ old('post', $pratihariAddress->post) }}" placeholder="Post office">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="state" name="state"
                                        value="{{ old('state', $pratihariAddress->state) }}" placeholder="State">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="country" name="country"
                                        value="{{ old('country', $pratihariAddress->country) }}" placeholder="Country">
                                </div>
                            </div>
                            ...
                            <div class="col-12 pt-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="differentAsPermanent"
                                        name="differentAsPermanent" {{ old('differentAsPermanent') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" id="per_sahi" name="per_sahi">
                                            ...
                                            @foreach ($sahiList as $sahi)
                                                <option value="{{ $sahi->id }}"
                                                    {{ old('per_sahi', $pratihariAddress->per_sahi) == $sahi->id ? 'selected' : '' }}>
                                                    {{ $sahi->sahi_name }}
                                                </option>
                                            @endforeach
                                        </select>
...
@section('scripts')
    ...
    <script>
        ...
        function syncPermanentVisibility() {
