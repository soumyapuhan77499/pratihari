...
@section('styles')
    ...
    <style>
        ...
        * { outline-color: var(--brand-b); }
        ...
        /* EXTRA: Better user card (partial relies on these) */
        .seba-user-card{ position:relative; text-align:center; padding:12px 10px; }
        .seba-user-card .user-avatar{
            width:64px; height:64px; border-radius:50%;
            object-fit:cover; border:2px solid var(--panel); box-shadow: var(--shadow);
        }
        .seba-user-card .name{ font-weight:800; margin-top:6px; color:var(--ink); text-decoration:none; }
        ...
        .seba-actions{ display:flex; justify-content:center; gap:6px; margin-top:8px; }
        .seba-actions .btn{ --bs-btn-padding-y:.25rem; --bs-btn-padding-x:.5rem; --bs-btn-font-size:.8rem; }
